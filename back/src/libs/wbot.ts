  ...
  return new Promise(async (resolve, reject) => {
    try {
      (async () => {
        ...
        type UserFacingSocketConfigPlus = Partial<UserFacingSocketConfig> & {
          auth: AuthenticationState;
          generateHighQualityLinkPreview: boolean;
          shouldIgnoreJid: any;
          patchMessageBeforeSending: any;
        };

        const config: UserFacingSocketConfigPlus = {
          version,
          logger: loggerBaileys,
